  ...
  return (
    <div className="container py-12">
      <div className="text-center mb-12">
        ...
        <p className="mt-2 text-lg text-muted-foreground">Sell your goods to the community and get a smart fee suggestion from our AI.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        <Card>
            <CardHeader>
                ...
                <CardDescription>Fill out the form below. The final listing fee will be added after AI suggestion.</CardDescription>
            </CardHeader>
