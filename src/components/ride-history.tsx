...
import { Car, Dot, History, Moped } from 'lucide-react';
      ...
      <CardContent>
        <div className="space-y-4">
            {userRides.map(ride => {
                ...
                return (
                    <div key={ride.id} className="p-4 rounded-lg border flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div className="text-right space-y-2 flex-shrink-0">
                           <div className="flex items-center justify-end gap-2">
                            ...
                            <Badge
                                ...
                                className={cn(ride.status === 'completed' && 'bg-green-100 text-green-800 border-green-200')}
                            >
                                {ride.status}
                            </Badge>
                        </div>
